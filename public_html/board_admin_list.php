                                 ...
                                 <p>
                                   ...
                                   <li class="nav-item ml-md-4">
                                                 ...
                                                 <script language="javascript">
                                                  function showPopup() { window.open("admin_popup.php", "a", "width=500, height=200, left=250, top=250"); }
                                                  </script>
                             <?php }; ?>
                </ul>
            </div>
                            ...
                            <ul>
                              <?php
                                ...
                                $pre = $page-1; //pre변수에 page-1을 해준다 만약 현재 페이지가 3인데 이전버튼을 누르면 2번페이지로 갈 수 있게 함
                                  echo "<a class='btn btn-primary'   href='?page=$pre'>이전</a>"; //이전글자에 pre변수를 링크한다. 이러면 이전버튼을 누를때마다 현재 페이지에서 -1하게 된다.
                                }
                                if($block_num >= $total_block){ //만약 현재 블록이 블록 총개수보다 크거나 같다면 빈 값
                                }else{
                                  $next = $page + 1; //next변수에 page + 1을 해준다.
                                  echo "<a class='btn btn-primary'  href='?page=$total_page'>다음</a>"; //다음글자에 next변수를 링크한다. 현재 4페이지에 있다면 +1하여 5페이지로 이동하게 된다.
                                }
                              ?>
                            </ul>
                          </div>
